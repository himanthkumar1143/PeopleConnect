...
const EducationCard = ({ resource }) => (
  <div className="
    ...
    hover:border-[#2563EB]/30 hover:shadow-[var(--shadow-card-hover)] hover:-translate-y-1 transition-all duration-300 ease-out
  ">
    ...
    <div className="flex items-start justify-between gap-2 relative z-10">
      <div className="flex-1">
        <h3 className="text-[15.5px] font-medium text-[#1E293B] leading-snug group-hover:text-[#2563EB] transition-colors">{resource.title}</h3>
        <p className="text-[13px] text-[#64748B] mt-0.5">{resource.courseName}</p>
      </div>
    ...
    {resource.description && (
      <p className="text-[13px] text-[#64748B] leading-relaxed line-clamp-2">{resource.description}</p>
    )}
