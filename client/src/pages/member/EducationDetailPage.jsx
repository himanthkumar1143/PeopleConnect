        ...
        <div className="bg-white rounded-xl border border-[#2563EB]/10 p-6 sm:p-8">
          ...
          <div className="flex items-start justify-between gap-3 mb-4">
            <div className="flex-1">
              <h1 className="text-[22px] font-medium text-[#1E293B]">{resource.title}</h1>
              <p className="text-[14px] text-[#64748B] mt-1">{resource.courseName}</p>
            </div>
            ...
            <div className="flex gap-2">
              {resource.resourceLink ? (
                <a
                  ...
                  className="text-[13px] text-[#2563EB] font-medium hover:underline flex items-center gap-1"
                >
                  Open Resource
